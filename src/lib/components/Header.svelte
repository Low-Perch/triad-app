...
<header class="flex w-full items-center relative p-4 py-2">
    ...
    <div class="relative flex justify-end items-center w-full space-x-2">
        <div tabindex="0" class="group relative inline-block">
            <button class="w-9 h-9 flex items-center place-content-center hover:rounded-full hover:bg-gray-600" id="support" name="support" on:click|preventDefault|stopPropagation={toggleClues}>
            ...
            <ul id="dropdown" class="absolute z-20 mt-2 hidden bg-gray-700 border-gray-200 border-2 text-sm -left-12 w-40 block text-white list-none">
