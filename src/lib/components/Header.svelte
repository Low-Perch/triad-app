...
<header class="flex w-full items-center relative p-4 py-2">
    ...
    <div class="relative flex justify-end items-center w-full space-x-2">
        ...
        <button class="w-9 h-9 flex items-center place-content-center hover:rounded-full hover:bg-gray-600" id="info" name="info" onclick={displayModal}>
        ...
        <button class="w-9 h-9 flex items-center place-content-center hover:rounded-full hover:bg-gray-600" id="stats" name="stats" onclick={displayModal}>
